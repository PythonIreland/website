...
uv run python pythonie/manage.py updatemeetups --settings=pythonie.settings.dev
...
# Local
uv run python pythonie/manage.py makemigrations --settings=pythonie.settings.dev
```
...
```bash
uv run python pythonie/manage.py migrate meetups --settings=pythonie.settings.dev
```

**Rollback migration**:
```bash
# Rollback to migration 0003
uv run python pythonie/manage.py migrate meetups 0003 --settings=pythonie.settings.dev
```
...
uv run python pythonie/manage.py collectstatic --settings=pythonie.settings.dev
```
...
# Local
uv run python pythonie/manage.py shell_plus --settings=pythonie.settings.dev
```
...
**Specific app**:
```bash
uv run python pythonie/manage.py test pythonie.meetups --settings=pythonie.settings.tests -v 2
```
...
**Specific method**:
```bash
uv run python pythonie/manage.py test pythonie.meetups.test_meetups.MeetupTestCase.test_future_events
```
...
uv run python pythonie/manage.py runserver
```
...
```bash
# Avoid
uv run python pythonie/manage.py migrate
...
uv run python pythonie/manage.py makemigrations

# Per app
uv run python pythonie/manage.py makemigrations meetups
uv run python pythonie/manage.py makemigrations sponsors
```
